...
import MessageTypeContainer from '../message-management/message-type/MessageTypeContainer';
...
export default function ChatManagePage(props) {
    ...
    <>
      ...
      <div className="message-container flex-center">
        <div className="message-table">
          <AdminTable
            apiGetData={`${environment.message}/${pageId}/conservations`}
            columns={columns}
